...
import { pendingDriversColumns } from './pending-drivers-columns'

type PendingDriversTableProps = {
  data: PendingDriverProfile[]
...
export function PendingDriversTable({
  ...
  return (
    <div className='space-y-4 max-sm:has-[div[role="toolbar"]]:mb-16'>
      <DataTableToolbar
        table={tableInstance}
        searchPlaceholder='Filter pending drivers...'
        ...
        <Table>
          ...
          <TableBody>
            {tableInstance.getRowModel().rows?.length ? (
              ...
              <TableRow>
                <TableCell
                  colSpan={pendingDriversColumns.length}
